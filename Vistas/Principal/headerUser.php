<?php
    ...
    //session_start();
//     $fila=$usuarioData->fetch_assoc();
// $_SESSION['usuarios'] = $fila['nombre']. " " . $fila['id'];
// echo $fila;
?>
<!DOCTYPE html>
<html lang="en">
        ...
        <nav>
            <div class="grid--container--2">
                <div class="g--informacion">
                    <a href="?menu=usuario"><img src="img/logo_transparent.png" width="150px" alt="" ></a> 
                </div>  
                <div class="g--logo"></div>      
                <div class="g--buttons">
                    <!-- <i class="fa-solid fa-magnifying-glass fa-6 img__iconColor">&nbsp;&nbsp;<input type="search" class="input" size="12" placeholder=""></i> -->
                    <button class="boton--sinFondo" type="button" data-toggle="modal" data-target="#menuModal">
                    <i class="fa-solid fa-bars fa-2x"></i></button>
                    <div class="dropdown">
                        <button class="boton--sinFondo"><i class="fa-solid fa-user fa-2x"></i></button>
                        <div class="dropdown-content">
                        <a href="">Mis concursos</a>
                        <a href="">Perfil</a>
    ...
    <div class="modal-content border-0 rounded-0">
      <div class="modal-header justify-content-center border-0 p-4">
        <figure class="d-inline-flex flex-column align-items-center m-0">
          <img class="rounded-circle" src="./././img/user.png" width="90">
          <figcaption class="mt-2">
            <?php echo $usuarioData->getEmail()?> 
            <?php echo $usuarioData->getId()?> 
        </figcaption>
        </figure>
      </div>
      <div class="modal-body text-uppercase px-0 py-4 flex-1">
        <ul class="nav flex-column justify-content-center">
          <li class="nav-item">
            <a class="nav-link" href="?menu=misConcursos" >Mis concursos</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="?menu=juez" >Siendo juez</a>
          </li>
          <!-- <li class="nav-item">
            <a class="nav-link" href="" rel="noopener noreferrer" target="_blank">Contactar</a>
          </li> -->
        </ul>
      </div>
